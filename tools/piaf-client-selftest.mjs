...
// ══════════════════════════════════════════════════════════════════════
// 7. LES OCTETS SERVIS — la seule vérification qui compte  (--production)
// ══════════════════════════════════════════════════════════════════════
if (!PROD) {
  console.log("\n── 7. les octets servis : SAUTÉE (relancer avec --production)");
} else {
  await sectionAsync("7. les octets SERVIS, en production", async () => {
